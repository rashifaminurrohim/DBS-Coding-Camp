export const notesApi = () => {
  ...
  const getAllNotes = async () => {
    try {
      const [unarchived, archived] = await Promise.all([getNotes(), getArchivedNotes()]);
  ...
  return { getNotes, createNote, deleteNote, archiveNote, getArchivedNotes, unarchiveNote, getAllNotes };
};
