...
export function genereateSubscribeOptions() {
  return {
...
export async function subscribe() {
  ...
  const successSubscribeMessage = 'Langgan push notification berhasil diaktifkan.';

  let pushSubscription;

  try {
    const registration = await navigator.serviceWorker.getRegistration();
    pushSubscription = await registration.pushManager.subscribe(genereateSubscribeOptions());
